    ...
    export default {
        ...
        methods: {
            ...
            async subscribeToMailingList() {
                let response = await this.$requests.get("user_info");
                console.log("rrrrrrrrrr", this.email, response);
    ...
    <div class="thanks-page">
        ...
        <template v-else>
            ...
            <div class="message-container">
                ...
                <div v-if="subscribed">You've been added to our mailing list!</div>
                <div v-else>
                    <p>
                        If you'd like to stay in the loop, we have a mailing list you can subscribed to. It's strictly
                        for shows in etc and so on
                    </p>
